...
from fairseq.models.baseline_model import (
    TransformerConfig,
...
class TransformerModelBase(FairseqEncoderDecoderModel):
    ...
    def __init__(self, cfg, encoder, decoder):
        ...
        self.future_linear = nn.Linear(256,10000)
        self.past_linear = nn.Linear(256,10000)
    ...
    def forward(
        ...
        encoder_out = self.encoder(
            src_tokens, src_lengths=src_lengths, return_all_hiddens=return_all_hiddens,img_global = img_global
        )
