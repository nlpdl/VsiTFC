...
from fairseq.models.baseline_model.transformer_config import (
    TransformerConfig,
    DEFAULT_MAX_SOURCE_POSITIONS,
    DEFAULT_MAX_TARGET_POSITIONS,
    DEFAULT_MIN_PARAMS_TO_WRAP,
)
from fairseq.models.baseline_model.transformer_base import (
    TransformerModelBase,
)


@register_model("baseline_transformer")
...
@register_model_architecture("baseline_transformer", "baseline_transformer")
