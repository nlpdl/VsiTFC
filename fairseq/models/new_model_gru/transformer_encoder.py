...
from fairseq.models.new_model_gru import transformer_layer
...
from fairseq.models.new_model_gru.utils import SublayerConnectionv2,PositionwiseFeedForward, deal_graph
...
class TransformerEncoderBase(FairseqEncoder):
    ...
    def reorder_encoder_out(self, encoder_out: Dict[str, List[Tensor]], new_order):
        ...
        if len(encoder_out["o"]) == 0:
            new_o = []
        else:
            new_o = [encoder_out["o"][0].index_select(1, new_order)]
