...
from fairseq.models.new_model_dy.transformer_config import (
    TransformerConfig,
    DEFAULT_MAX_SOURCE_POSITIONS,
    DEFAULT_MAX_TARGET_POSITIONS,
    DEFAULT_MIN_PARAMS_TO_WRAP,
)
from fairseq.models.new_model_dy.transformer_base import (
    TransformerModelBase,
)


@register_model("new_model_dy_transformer")
...
@register_model_architecture("new_model_dy_transformer", "new_model_dy_transformer")
