...
from fairseq.models.new_model_up_tirl.transformer_config import (
    TransformerConfig,
    DEFAULT_MAX_SOURCE_POSITIONS,
    DEFAULT_MAX_TARGET_POSITIONS,
    DEFAULT_MIN_PARAMS_TO_WRAP,
)
from fairseq.models.new_model_up_tirl.transformer_base import (
    TransformerModelBase,
)


@register_model("new_model_up_tirl_transformer")
...
@register_model_architecture("new_model_up_tirl_transformer", "new_model_up_tirl_transformer")
