...
from fairseq.models.generator_model.transformer_config import (
    TransformerConfig,
    DEFAULT_MAX_SOURCE_POSITIONS,
    DEFAULT_MAX_TARGET_POSITIONS,
    DEFAULT_MIN_PARAMS_TO_WRAP,
)
from fairseq.models.generator_model.transformer_base import (
...
@register_model_architecture("generator", "generator")
