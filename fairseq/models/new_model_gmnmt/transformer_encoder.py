...
from fairseq.models.new_model_gmnmt import transformer_layer
...
from fairseq.models.new_model_gmnmt.utils import SublayerConnectionv2,PositionwiseFeedForward, deal_graph
...
class TransformerEncoderBase(FairseqEncoder):
    ...
    def forward_scriptable(
        ...
        limit_index = limit_obj(d)
        # d_index = d.cpu().numpy()
        # index = np.argwhere(d_index == 1)
        # print(index)
        # assert 1 == 0
