...
from fairseq.models.new_model.utils import *
import torch
...
from fairseq.models.new_model import TransformerConfig
...
class TransformerDecoderBase(FairseqIncrementalDecoder):
    ...
    def extract_features_scriptable(
        ...
        return x, {"attn": [attn], "inner_states": inner_states,"past_caps":past_caps,"future_caps":future_caps,"x":x,"now_x":now_x,"no_gate_x":no_gate_x}
