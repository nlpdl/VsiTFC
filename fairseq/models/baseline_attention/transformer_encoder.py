...
from fairseq.models.baseline_attention import transformer_layer
...
class TransformerEncoderBase(FairseqEncoder):
    ...
    def forward(
        ...
        return self.forward_scriptable(
            src_tokens, src_lengths, return_all_hiddens, token_embeddings,img_global
        )
    ...
    def forward_scriptable(
        ...
        oov_enc = self.self_attn_layer_norm(oov_enc)
    ...
    def reorder_encoder_out(self, encoder_out: Dict[str, List[Tensor]], new_order):
        ...
        if len(encoder_out["oov_enc"]) == 0:
            ...
            new_oov_enc = [encoder_out["oov_enc"][0].index_select(1, new_order)]
