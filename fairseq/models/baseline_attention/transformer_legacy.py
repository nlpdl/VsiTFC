...
from fairseq.models.baseline_attention.transformer_config import (
    TransformerConfig,
    DEFAULT_MAX_SOURCE_POSITIONS,
    DEFAULT_MAX_TARGET_POSITIONS,
    DEFAULT_MIN_PARAMS_TO_WRAP,
)
from fairseq.models.baseline_attention.transformer_base import (
    TransformerModelBase,
)


@register_model("baseline_attention_transformer")
...
@register_model_architecture("baseline_attention_transformer", "baseline_attention_transformer")
